...
/*
 하위 컨트롤러들이 직접 요청을 받게 되면, 업무의 효율성과 유지보수성이 저하된다, 우리의 경우 너무 많은 서블릿 매핑이 생겨남
 따라서, 규모가 아무리 커질지라도 모든 요청을 하나의 진입점으로 몰아서, 요청의 유형을 분석하여 적절한 컨트롤러들에게 배분
...
public class DispatcherServlet extends HttpServlet{
	...
	protected void doRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("클라이언트의 요청URI는"+uri);
